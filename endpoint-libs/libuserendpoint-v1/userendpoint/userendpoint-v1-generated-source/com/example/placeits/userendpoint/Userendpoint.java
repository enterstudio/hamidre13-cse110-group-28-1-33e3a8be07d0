 ...
 * on 2014-03-16 at 01:27:19 UTC 
 * Modify at your own risk.
 */

package com.example.placeits.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.example.placeits.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.example.placeits.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.example.placeits.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.example.placeits.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.example.placeits.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.example.placeits.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.example.placeits.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.example.placeits.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.example.placeits.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.example.placeits.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.example.placeits.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.example.placeits.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.example.placeits.userendpoint.model.User.class);
    }
